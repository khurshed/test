...
<td><?php echo  $form->fileField($model,'image');?><span><?php echo $form->error($model,'image');?></span></td>
</tr>
<tr>
<td colspan="2"><?php echo  CHtml::submitButton('Save', array('confirm'=>'You agree to the term to register.\n\nPress OK to continue.'));?></td>
</tr>
</table>
<?php
$this->endWidget();
